...
export const InternalErrors = {
  ...
  FETCHING_CHART_DATA: 'Internal server error while fetching chart data',
  FETCHING_ALERT_TRENDS: 'Internal server error while fetching alert trends',
  FETCHING_RISK_DISTRIBUTION: 'Internal server error while fetching risk distribution',
  FETCHING_TRANSACTION_VOLUME: 'Internal server error while fetching transaction volume',
  FETCHING_RECENT_ACTIVITY: 'Internal server error while fetching recent activity',
